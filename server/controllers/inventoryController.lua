...
RegisterServerEvent("vorpinventory:serverDropItemDeath")
AddEventHandler("vorpinventory:serverDropItemDeath", InventoryService.DropItemDeath)

RegisterServerEvent("vorpinventory:serverDropWeaponDeath")
AddEventHandler("vorpinventory:serverDropWeaponDeath", InventoryService.DropWeaponDeath)
