...
InventoryAPI.registerWeapon = function(target, name, ammos, components, comps, status)
...
InventoryAPI.giveWeapon2 = function(player, weaponId, target)
	...
	exports.oxmysql:execute('SELECT * FROM loadout WHERE id = @id ', { ['id'] = weaponId }, function(result)
		if result[1] ~= nil then
			...
			InventoryAPI.registerWeapon(_source, weaponname, {}, {}, json.decode(result[1].comps), weaponStatus)
