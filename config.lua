...
Config = {
  ...
  -- FIRST JOIN
  startItems = {
    consumable_coffee = 5, --ITEMS SAME NAME AS IN DATABASE
    consumable_kidneybeans_can = 5,
    goldpan = 1, --AMMO SAME NAME AS I NTHE DATABASE
    book = 1 --AMMO SAME NAME AS I NTHE DATABASE
  },
